...
{
    #region Class Description "Класс регистрации событий для процедур калькулятора"
    /// <summary>
    /// Класс регистрации событий для процедур калькулятора.
    /// <para>Реализует интерфейс <see cref="ILogger"/> для логирования событий и ошибок, связанных с процедурами класса <see cref="Calculator"/>:</para>
    /// <list type="bullet">
    ...
    /// </summary>
    #endregion
    public class ProcedureLogger : ILogger
    {
        ...
        /// <list type="number">
        ///   <item><description>Хранит тип регистратора, возвращая значение из <see cref="LoggerTypes.Procedure"/>.</description></item>
        ///   <item><description>Предоставляет доступ только для чтения.</description></item>
        /// </list>
        /// </summary>
        #endregion
        public string Type => LoggerTypes.Procedure; // Возвращает тип регистратора для процедур калькулятора
        ...
        ///   <item><description>Выводит информацию о времени, процедуре и сообщении об ошибке.</description></item>
        ///   <item><description>Сбрасывает настройки консоли и очищает буфер вывода.</description></item>
        /// </list>
        /// </summary>
        /// <param name="nameProcedure">Строковый параметр типа <see cref="string"/>, представляющий название процедуры.</param>
        ...
        ///   <item><description>Выводит информацию о времени, процедуре и сообщении о событии.</description></item>
        ///   <item><description>Сбрасывает настройки консоли и очищает буфер вывода.</description></item>
        /// </list>
        /// </summary>
        /// <param name="nameProcedure">Строковый параметр типа <see cref="string"/>, представляющий название процедуры.</param>
