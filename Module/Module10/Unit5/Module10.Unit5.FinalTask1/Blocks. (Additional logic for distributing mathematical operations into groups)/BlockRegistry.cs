...
{
    /// <summary>
    /// <para>Класс BlockRegistry - "Регистрации блоков математических операций"</para>
    ...
    {
        /// <summary>
        /// <para>Приватное статическое поле-словарь "Реестр блоков математических операций"</para>
